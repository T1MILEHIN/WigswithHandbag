...
const Page = () => {
    ...
    return (
        <div className="flex flex-col gap-5 my-4">
            ...
            <motion.button onClick={() => postBundles()} disabled={perc !== null && perc < 100} whileTap={{ scale: 0.95 }} className="bg-black text-white rounded-sm p-2 disabled:bg-red-600 disabled:cursor-not-allowed">UPLOAD BUNDLE</motion.button>
        </div>
    )
}
